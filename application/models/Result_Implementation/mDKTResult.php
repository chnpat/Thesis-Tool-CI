<?php
	...
	/**
	 *	mDKTResult is a model class for managing the result of DKT metric
	 *
	 *	mDKTResult is a model class for managing the result of DKT metric and includes the CRUDE operation,
	...
	class mDKTResult extends CI_Model implements iAssessResult{
		...
		/**
		 *	create_result() is a model function for creating a new DKT metrics' result.
		 *
		 *	create_result() is a model function for creating a new DKT metrics' result into the database.
		 *
		...
		/**
		 * 	get_result_all() is a model function for getting all result of DKT metric of the specified pattern
		 *
		 *	get_result_all() is a model function for getting all result of DKT metric of the specified pattern
		 ...
		 *										floating number.
		 *
		 *	@return 	array 					An array of DKT metric results of the specified pattern.
		 */
		public function get_result_all($pat_id, $ver=NULL){
			...
			if($result != NULL){
				...
				/** Runs through all result of DKT metric in the database */
		 ...
		 *
		 *	calculate_result() is a model function for calculating the final result from the passing parameters
		 *	which is different from the DKT metric.
		 *
